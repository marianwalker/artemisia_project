...
ggplot(data = bulk_avg, aes(x = zone, y = mean_bulk, color = zone))+
  ...
  theme(plot.title = element_text(color = "#5b4f41", size = 16, hjust = 0.5),
        ...
        axis.text = element_text(color = "#5b4f41", size = 10, face = "italic"),
        axis.title = element_text(color = "#5b4f41", size = 14),
...
ggplot(art_soil, aes(x = bulk_den, y = branch_cm))+
 geom_point(aes(color = zones, shape = zones))+
  scale_color_manual(values = c("wheat", "chartreuse4"))+
  geom_smooth(method = "lm", color = "#5b4f41")+
  labs(x = "Bulk Density (g/cm^3)",
       y = "Longest Branch Length (cm)",
       title = "Bulk Density vs Branch Length")+
...
```{r}
ggplot(art_soil, aes(x = bulk_den, y = branch_cm))+
  geom_point(aes(shape = zones, fill = zones), size = 2)+
  scale_shape_manual(values = c(24, 21))+
  scale_fill_manual(values = c("wheat", "chartreuse4"))+
  scale_color_manual(values = c("black", "black"))+
  geom_smooth(method = "lm", color = "#5b4f41", linewidth = 1.25)+
  labs(x = expression(paste("Bulk Density ",  g/cm^{3})),
       y = "Longest Branch Length (cm)",
       title = "Bulk Density vs. Branch Length",
       shape = "Zone",
       fill = "Zone")+
